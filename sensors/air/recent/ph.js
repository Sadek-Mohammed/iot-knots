...
firebaseRef.once("value").then((snapshot) => {
    ...
    new Chart(document.getElementById(`phGraphMin`), {
        ...
        data: {
            labels: timer,
            datasets: [{
                label: `Air Quality Minimum Value`,
                data: air.min,
                borderWidth: 1
            }]
        },
    ...
    new Chart(document.getElementById(`phGraphMax`), {
        ...
        data: {
            labels: timer,
            datasets: [{
                label: `Air Quality Maximum Value`,
                data: air.max,
                borderWidth: 1
            }]
        },
    ...
    new Chart(document.getElementById(`phGraphMean`), {
        ...
        data: {
            labels: timer,
            datasets: [{
                label: `Air Quality Average Value`,
                data: air.mean,
                borderWidth: 1
            }]
        },
    ...
    new Chart(document.getElementById(`phGraphDev`), {
        ...
        data: {
            labels: timer,
            datasets: [{
                label: `Air Quality Media Abdolute Deviation`,
                data: air.dev,
                borderWidth: 1
            }]
        },
    ...
    new Chart(document.getElementById(`phGraphMedian`), {
        ...
        data: {
            labels: timer,
            datasets: [{
                label: `Air Quality Median Value`,
                data: air.median,
                borderWidth: 1
            }]
        },
    ...
    let skewness = ss.sampleSkewness(air.reading);
